...
import RamadanOperationsDiagram from '../../components/brand/RamadanOperationsDiagram';
  ...
  return (
    <>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-sidqly-deepNavy mb-4">Ramadan Operational Journey</h2>
            <p className="text-sidqly-slateText max-w-2xl mx-auto">Scale your food drives and ration distributions with professional verification.</p>
          </div>
          <RamadanOperationsDiagram />
        </div>
      </section>
      ...
      <section className="py-24 bg-sidqly-warmIvory/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="text-center mb-16">
             <h2 className="text-3xl font-bold text-sidqly-deepNavy mb-4">Precision in the Holy Month</h2>
             <p className="text-sidqly-slateText max-w-2xl mx-auto">Coordinate complex logistics across multiple teams and locations with ease.</p>
           </div>
