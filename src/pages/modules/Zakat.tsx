...
import ZakatSeparationDiagram from '../../components/brand/ZakatSeparationDiagram';
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="grid lg:grid-cols-2 gap-16 items-center">
             ...
             <div className="p-1 bg-sidqly-warmIvory rounded-3xl overflow-hidden shadow-inner">
               <ZakatSeparationDiagram />
             </div>
           </div>
        </div>
      </section>
