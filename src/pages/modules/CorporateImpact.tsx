...
import CorporateImpactDiagram from '../../components/brand/CorporateImpactDiagram';
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-sidqly-deepNavy mb-4">Board-Ready CSR Transparency</h2>
            <p className="text-sidqly-slateText max-w-2xl mx-auto">Sidqly provides the professional framework required for modern corporate giving.</p>
          </div>
          <CorporateImpactDiagram />
        </div>
      </section>

      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="bg-sidqly-deepNavy p-12 md:p-20 rounded-[3rem] text-white">
