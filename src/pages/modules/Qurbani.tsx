...
import QurbaniLifecycleDiagram from '../../components/brand/QurbaniLifecycleDiagram';
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-sidqly-deepNavy mb-4">Complete Qurbani Lifecycle</h2>
            <p className="text-sidqly-slateText max-w-2xl mx-auto">Manage every animal, share, and meat pack with professional precision.</p>
          </div>
          <QurbaniLifecycleDiagram />
        </div>
      </section>
