...
import ManualPaymentFlow from '../components/brand/ManualPaymentFlow';
    ...
    <>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {plans.map((plan, i) => (
              ...
              >
                ...
                <a
                  ...
                  plan.popular ? 'bg-sidqly-deepGreen text-white hover:bg-sidqly-emeraldGreen shadow-lg' : 'bg-sidqly-deepNavy text-white hover:bg-slate-800'
                }`}>
                  Book a Demo
                </a>
              </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
             <a href={brand.inquiryFormUrl} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 px-8 py-4 bg-white border border-sidqly-mutedBorder rounded-full font-bold text-sidqly-deepNavy hover:bg-sidqly-warmIvory transition-all">
               <FileText className="h-5 w-5" /> Detailed Inquiry Form
             </a>
             <a href={`mailto:${brand.email}`} className="flex items-center justify-center gap-2 px-8 py-4 bg-white border border-sidqly-mutedBorder rounded-full font-bold text-sidqly-deepNavy hover:bg-sidqly-warmIvory transition-all">
      ...
      <section className="py-24 bg-sidqly-deepNavy text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-8">Official Payment Details</h2>
          <p className="text-gray-400 mb-12">Sidqly uses a manual verification process for all subscription and setup payments.</p>
          ...
          <div className="bg-white/5 p-8 rounded-3xl border border-white/10 text-left">
            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-6">
                <div>
                  <h4 className="text-sidqly-goldAccent font-bold uppercase tracking-widest text-xs mb-2">Payment Method</h4>
                  <p className="text-xl font-semibold">{brand.payment.method}</p>
                </div>
                <div>
                  <h4 className="text-sidqly-goldAccent font-bold uppercase tracking-widest text-xs mb-2">IBAN</h4>
                  <p className="text-xl font-mono tracking-wider break-all">{brand.payment.iban}</p>
                </div>
              </div>
              <div className="space-y-6">
                <div>
                  <h4 className="text-sidqly-goldAccent font-bold uppercase tracking-widest text-xs mb-2">Confirmation Email</h4>
                  <div className="flex items-center gap-2">
                    <Mail className="h-5 w-5 text-gray-400" />
                    <p className="text-xl font-semibold">{brand.payment.confirmationEmail}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 pt-12 border-t border-white/10 text-sm text-gray-400 space-y-4">
              ...
              <p>After payment, please email your payment screenshot, organization name, selected plan, and contact person details to <span className="text-white">{brand.payment.confirmationEmail}</span>.</p>
